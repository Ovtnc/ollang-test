...
import Deposits from "../components/UpgradePro";
...
const logo = require('../644082449df5ab2b939848e7_ollang-logo.webp');
            ...
            <Box sx={{display: 'flex'}}>
                ...
                <AppBar sx={{
                    ...
                    >
                        ...
                        >
                            <Box component={"img"} src={logo} sx={{width: 100, marginRight: 1, mt: 1}}/>
                        </Box>
